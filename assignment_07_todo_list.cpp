...
int main() {
    ...
    while (choice != 4) {
        ...
        // Clear input buffer after reading an integer choice
        cin.ignore(10000, '\n');
...
// Function to print the main interaction menu
void displayMenu() {
    cout << "============================" << endl;
...
void deleteTask(vector<string>& tasks) {
    ...
    if (taskNum < 1 || taskNum > static_cast<int>(tasks.size())) {
        ...
        // Convert 1-based display index back to 0-based vector index
        int index = taskNum - 1;
